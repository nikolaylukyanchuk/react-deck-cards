...
const StudyModel = ( { card, showBack, onFlip, deckId, onStudied  } ) => {
         ...
         body = (<div className="study-card">
            ...
            <div className={ showBack ? 'back' : 'back hide' }>
                ...
                <p>
                    ...
                    <button onClick={e => onStudied(card.id, card.score)}> Okey </button>
...
export default connect(mapStateToProps, mapDispatchToProps)(StudyModel);